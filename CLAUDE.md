...
- STATUS (updated 2026-08-05): IP route for the أنمي image wave decided — see provenance note below. بباي الطيبين wave 2 remains undecided. خمن الشعار is NOT undecided — it was DROPPED permanently on 2026-08-01 and will not be built.
- أنمي silhouettes (public/anime/, 57 files): original silhouette artwork generated by the owner using Google Gemini (Nano Banana), derived from third-party character designs. No license is held in the underlying characters. Silhouettes chosen as the minimum-exposure route; risk accepted by the owner. Trademark/copyright exposure is unchanged by the fact that the files themselves are owner-generated.
